...
if __name__ == '__main__':
    ...
    if not os.path.exists(CONFIG.RESULT_FOLDER + str(CONFIG.METHOD6)):
        os.makedirs(CONFIG.RESULT_FOLDER + str(CONFIG.METHOD6))
    client.success_file = open(CONFIG.RESULT_FOLDER + str(CONFIG.METHOD6) + '/result_success.csv', "a", newline='')
    print('生成成功的输出结果文件')
    ...
    client.error_file = open(CONFIG.RESULT_FOLDER + str(CONFIG.METHOD6) + '/result_error.csv', "a", newline='')
    print('生成失败的输出结果文件')
    ...
    if not os.path.exists(CONFIG.RESULT_FOLDER + str(CONFIG.METHOD6)+'/result'):
        os.mkdir(CONFIG.RESULT_FOLDER+ str(CONFIG.METHOD6)+'/result')
    ...
    for i in range(0, 10000000000000000):
        ...
        temp_c.upload_data_gas(data2, c, r, i, CONFIG.RANDOM_METHOD)
        print(i, '  ', c_id)
